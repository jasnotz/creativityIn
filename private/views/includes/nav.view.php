<style>
  ...
  nav ul li a:hover{
    color: '#5a5226' !important;
  }

  .active-nav{
    background-color: '#5a5226' !important;
  }
</style>
<nav class="main-nav navbar navbar-expand-lg navbar-light bg-light p-2">
  	<a class="navbar-brand" style="margin-left: 2%" href="<?=ROOT?>">
  		<img src="<?=ROOT?>/assets/logo.jpg" class="" style="width:50px;">
  		 <img src="<?=ROOT?>/assets/logo-text.png" style="width:120px; margin-right: 2%;">
	</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <ul class="navbar-nav ms-auto" style="margin-right: 3%;>
      ...
      <form class="form-inline">
        <div class="input-group">
          ...
          <?php $years = get_years()?>
          <select name="school_year" class="form-select" style="display: none;max-width:100px">
          ...
          <div class="input-group-prepend">
            <button class="input-group-text" style="display: none;" id="basic-addon1">&nbsp<i class="fa fa-chevron-right"></i></button>
          </div>
        </div>
      </form>
